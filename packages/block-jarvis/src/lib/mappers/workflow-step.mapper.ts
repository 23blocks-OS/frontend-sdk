...
export const workflowStepMapper: ResourceMapper<WorkflowStep> = {
  ...
  map: (resource) => ({
    ...
    stepType: parseString(resource.attributes['step_type']) || undefined,
    gatewayType: parseString(resource.attributes['gateway_type']) || undefined,
    isEntryPoint: resource.attributes['is_entry_point'] != null ? parseBoolean(resource.attributes['is_entry_point']) : undefined,
    isExitPoint: resource.attributes['is_exit_point'] != null ? parseBoolean(resource.attributes['is_exit_point']) : undefined,

...
export const aiModelMapper: ResourceMapper<AIModel> = {
  ...
  map: (resource) => ({
    ...
    inputTokenCostCurrency: parseString(resource.attributes['input_token_cost_currency']) || undefined,
    outputTokenCost: parseOptionalNumber(resource.attributes['output_token_cost']),
    outputTokenCostCurrency: parseString(resource.attributes['output_token_cost_currency']) || undefined,

...
export const channelMapper: ResourceMapper<Channel> = {
  ...
  map: (resource) => ({
    ...
    metaKeywords: parseString(resource.attributes['meta_keywords']),
    slug: parseString(resource.attributes['slug']),
    currencyUniqueId: parseString(resource.attributes['currency_unique_id']),
    currencyCode: parseString(resource.attributes['currency_code']),
    currencyName: parseString(resource.attributes['currency_name']),
    apiDescription: parseString(resource.attributes['api_description']),
    apiUrl: parseString(resource.attributes['api_url']),
    apiKeysDescription: parseString(resource.attributes['api_keys_description']),
    apiKeysId: parseString(resource.attributes['api_keys_id']),
    status: parseStatus(resource.attributes['status']),
    enabled: parseBoolean(resource.attributes['enabled']),
  }),
};
...
export const productCatalogMapper: ResourceMapper<ProductCatalog> = {
  ...
  map: (resource) => ({
    ...
    imageUrl: parseString(resource.attributes['image_url']),
    thumbnailUrl: parseString(resource.attributes['thumbnail_url']),
    itemsCounter: parseOptionalNumber(resource.attributes['items_counter']),
    isGlobal: parseBoolean(resource.attributes['is_global']),
    countryId: parseString(resource.attributes['country_id']),
    countryName: parseString(resource.attributes['country_name']),
    currencyUniqueId: parseString(resource.attributes['currency_unique_id']),

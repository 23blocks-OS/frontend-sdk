...
- **@23blocks/sdk:** rebuild with submissions payload restructure ([0d5c444](https://github.com/23blocks-OS/frontend-sdk/commit/0d5c444))

### 📖 Documentation

- document submissions payload shape in llms.txt ([ff6bebd](https://github.com/23blocks-OS/frontend-sdk/commit/ff6bebd))
...
- **@23blocks/sdk:** rebuild with conversations tasks sub-service ([9e23c6f](https://github.com/23blocks-OS/frontend-sdk/commit/9e23c6f))
...
- ⚠️  **@23blocks/sdk:** rebuild with jarvis prompts Prompt|PromptVersion tolerance ([8fb1330](https://github.com/23blocks-OS/frontend-sdk/commit/8fb1330))

### ⚠️  Breaking Changes

- **@23blocks/sdk:** rebuild with jarvis prompts Prompt|PromptVersion tolerance  ([8fb1330](https://github.com/23blocks-OS/frontend-sdk/commit/8fb1330))
...
- ⚠️  **@23blocks/sdk:** rebuild with block-products shoppingLists rewrite + transport DELETE body support ([7a1d167](https://github.com/23blocks-OS/frontend-sdk/commit/7a1d167))

### ⚠️  Breaking Changes

- **@23blocks/sdk:** rebuild with block-products shoppingLists rewrite + transport DELETE body support  ([7a1d167](https://github.com/23blocks-OS/frontend-sdk/commit/7a1d167))
...
- **@23blocks/sdk:** rebuild with jarvis conversations.listByUser path + archive/rename/restore methods ([7c09469](https://github.com/23blocks-OS/frontend-sdk/commit/7c09469))
...
- **@23blocks/sdk:** rebuild with jarvis conversation/message JSON:API parser ([18163dd](https://github.com/23blocks-OS/frontend-sdk/commit/18163dd))
...
- **@23blocks/sdk:** rebuild with JSON:API parser fixes (jarvis + products visitors) ([75e0fe6](https://github.com/23blocks-OS/frontend-sdk/commit/75e0fe6))
...
- **@23blocks/sdk:** rebuild with UUID validation utilities ([e59a209](https://github.com/23blocks-OS/frontend-sdk/commit/e59a209))
...
- **@23blocks/sdk:** rebuild with DigestResponse type ([524006b](https://github.com/23blocks-OS/frontend-sdk/commit/524006b))
...
- **@23blocks/sdk:** rebuild with reCAPTCHA v3 token support ([45b06e0](https://github.com/23blocks-OS/frontend-sdk/commit/45b06e0))
...
- **@23blocks/sdk:** rebuild with delegations CRUD and conversations unread summary ([e2ab290](https://github.com/23blocks-OS/frontend-sdk/commit/e2ab290))
...
- **@23blocks/sdk:** rebuild with supervisor handoff and delegation management ([fec35a9](https://github.com/23blocks-OS/frontend-sdk/commit/fec35a9))
...
- **@23blocks/sdk:** add block-rag namespace export ([30d1140](https://github.com/23blocks-OS/frontend-sdk/commit/30d1140))

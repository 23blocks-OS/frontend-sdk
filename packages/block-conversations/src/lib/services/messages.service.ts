      ...
      const response = await transport.post<unknown>('/messages', {
        message: {
            ...
            actions: data.actions?.map((a) => ({
              ...
              control_label: a.controlLabel,
              control_value: a.controlValue,
              control_name: a.controlName,
              control_id: a.controlId,
              control_class: a.controlClass,
              control_tag: a.controlTag,
              control_placeholder: a.controlPlaceholder,
              control_href: a.controlHref,
              control_src: a.controlSrc,
              control_alt: a.controlAlt,
              control_help: a.controlHelp,
              control_set_id: a.controlSetId,
              control_set_name: a.controlSetName,
              control_set_class: a.controlSetClass,
              status: a.status,
              enabled: a.enabled,
              payload: a.payload,
              response: a.response,

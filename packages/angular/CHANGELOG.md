...
- **@23blocks/angular:** rebuild with UUID validation + file-upload docs ([62a4668](https://github.com/23blocks-OS/frontend-sdk/commit/62a4668))
...
- **@23blocks/angular:** rebuild with Company.agentAuthorizationDomain ([1511f13](https://github.com/23blocks-OS/frontend-sdk/commit/1511f13))
...
- **@23blocks/angular:** rebuild with batch messaging for conversations ([9f3d26c](https://github.com/23blocks-OS/frontend-sdk/commit/9f3d26c))
...
- **@23blocks/angular:** rebuild with strong params audit fields ([7b7ba3f](https://github.com/23blocks-OS/frontend-sdk/commit/7b7ba3f))
...
- **@23blocks/angular:** rebuild with provider field for prompts and agents ([c8f3446](https://github.com/23blocks-OS/frontend-sdk/commit/c8f3446))
...
- **@23blocks/angular:** rebuild with JSON:API codec fixes for jarvis and sales blocks ([8f0c197](https://github.com/23blocks-OS/frontend-sdk/commit/8f0c197))
...
- **@23blocks/angular:** add messageActions getter to ConversationsService ([1baa340](https://github.com/23blocks-OS/frontend-sdk/commit/1baa340))
...
- **@23blocks/angular:** add analytics getter to JarvisService ([19ff542](https://github.com/23blocks-OS/frontend-sdk/commit/19ff542))
...
- **@23blocks/angular:** add RagService with delegation pattern ([bdd4305](https://github.com/23blocks-OS/frontend-sdk/commit/bdd4305))

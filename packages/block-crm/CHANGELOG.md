...
- **@23blocks/block-crm:** pin internal deps to caret ranges (no more wildcards) ([#3](https://github.com/23blocks-OS/frontend-sdk/issues/3))
...
This was a version bump only for @23blocks/block-crm to align it with other projects, there were no code changes.
